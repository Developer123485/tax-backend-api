...
{
    public partial class DeducteeEntry
    {
        ...
        [NotMapped]
        public string? DeducteePanRef { get; set; }
        [NotMapped]
        public string TDSDepositByBook { get; set; }
        [NotMapped]
        public string ReasonValue { get; set; }
        [NotMapped]
        public string SectionCodeValue { get; set; }
        ...
        public virtual Challan? Challans { get; set; }
        public virtual User? Users { get; set; }
        public virtual Category? Category { get; set; }
        public virtual Deductor? Deductor { get; set; }
        public virtual Employee? Employee { get; set; }
        public virtual Deductee? Deductee { get; set; }
    }
    public class DeducteeDataModel
    {
        public List<DeducteeEntry> DeducteeEntryList { get; set; }
        public List<ChallanDropdown> Challans { get; set; }
        public int TotalRows { get; set; }
    }

    public class DeducteeDropdown
    {
